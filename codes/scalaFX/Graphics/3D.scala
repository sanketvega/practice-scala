...
val app = new JFXApp {
    stage = new JFXApp.PrimaryStage {
      ...
      scene = new Scene(400, 400) {
        val marsImage = new Image("https://upload.wikimedia.org/wikipedia/commons/f/f5/3D_Mars.png")
        ...
        point.translateY = -400

        val usePerspective = new CheckBox("Persppective View")
