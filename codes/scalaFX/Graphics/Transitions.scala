...
val app = new JFXApp {
    stage = new JFXApp.PrimaryStage {
      ...
      scene = new Scene(600, 400) {
        ...
        val seqTrnas = new SequentialTransition(rect1, List(fadeTrans, pathTrans, strokeTrans))
        seqTrnas.autoReverse = true
        seqTrnas.cycleCount = 4

        val startButton = new Button("Start")
        startButton.onAction = (e:ActionEvent) => seqTrnas.play
        val pauseButton = new Button("Pause")
        pauseButton.onAction = (e:ActionEvent) => seqTrnas.pause
        val stopButton = new Button("Stop")
        stopButton.onAction = (e:ActionEvent) => seqTrnas.stop
